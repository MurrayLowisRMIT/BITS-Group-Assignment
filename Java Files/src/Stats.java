...
public class Stats
{
   ...
   //path decision from scene 5 onwards
   protected int pathSc5Decision =0 ;
   //path decision from s11a
   protected int pathSc11aDecision =0 ;
}
